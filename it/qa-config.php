...
*/
	...
	define('QA_MYSQL_HOSTNAME', 'eu-cdbr-azure-west-a.cloudapp.net');
	define('QA_MYSQL_USERNAME', 'b533c9ef42a708');
	define('QA_MYSQL_PASSWORD', 'ad6d3d4e');
	define('QA_MYSQL_DATABASE', 'q2ademodb');
